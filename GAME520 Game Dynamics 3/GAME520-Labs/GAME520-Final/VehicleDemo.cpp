...
void VehicleDemo::spawnRagdoll( const btVector3& startOffset, const float scale )
{
...
#define  USE_TRIMESH_GROUND 1
	...
	btCollisionShape* carWallShape = new btBoxShape( btVector3( 0.1f, 0.7f, 1.0f ) );
	...
	localTrans.setOrigin( btVector3( 0.9f, wallHeight, 0 ) );
	compound->addChildShape( localTrans, carWallShape );

	localTrans.setOrigin( btVector3( -0.9f, wallHeight, 0 ) );
	compound->addChildShape( localTrans, carWallShape );

	localTrans.setRotation( btQuaternion( M_PI_2 , 0, 0 ) );
	localTrans.setOrigin( btVector3( 0, wallHeight, 0.9f ) );
	compound->addChildShape( localTrans, carWallShape );
	...
	spawnRagdoll( btVector3( 0, 2, 0 ), 1.75f );

	spawnRagdoll( btVector3( 0, 20, 40 ), 10.0f );
	...
	///////////////////////////////////////////////////////////////////////////////////////////////
	{
		btCollisionShape* rampShape = new btBoxShape( btVector3( 4.0f, 0.5f, 4.0f ) );
		m_collisionShapes.push_back( rampShape );

		btTransform localTrans;
		localTrans.setIdentity();

		localTrans.setOrigin( btVector3( 0, -4, 22 ) );
		localTrans.setRotation( btQuaternion( 0, -60, 0 ) );

		localCreateRigidBody( 0, localTrans, rampShape );
