...
public:
	...
	*/
	...
	/**
	*  This takes two entities which have already been added to the scene graph, finds
	* them, 
	*/
	static Ogre::SceneNode *createCommonParent(Ogre::String &ent1, Ogre::String &ent2);
